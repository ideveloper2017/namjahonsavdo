...
use Theme\Chorsuname\Http\Requests\CustomPostRequest;
use Theme\Chorsuname\Repositories\Eloquent\PostRepository;
...
RvMedia::addSize('large', 1024)->addSize('medium_large', 600, 421);
